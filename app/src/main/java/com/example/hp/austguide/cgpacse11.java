...
public class cgpacse11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cgpacse11);
        a = (EditText) findViewById(R.id.hummarks);
        b = (EditText) findViewById(R.id.chemmarks);
        c = (EditText) findViewById(R.id.phymarks);
        d = (EditText) findViewById(R.id.csemarks);
        e = (EditText) findViewById(R.id.mathmarks);
        f = (EditText) findViewById(R.id.humlabmarks);
        g = (EditText) findViewById(R.id.phylabmarks);

        h = (EditText) findViewById(R.id.clabmarks);

        i = (EditText) findViewById(R.id.c1108labmarks);
...
{
    gh.start();
    Toast.makeText(getApplicationContext(), "any of your marks feild is empty!!! please check it :) ", Toast.LENGTH_SHORT).show();
}
