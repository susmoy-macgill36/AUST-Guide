...
public class cgpacse12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cgpacse12);
        a1=(EditText) findViewById(R.id.hummarks1);
        b1=(EditText) findViewById(R.id.chemmarks1);
        c1=(EditText) findViewById(R.id.phymarks1);
        d1=(EditText) findViewById(R.id.csemarks1);
        e1=(EditText) findViewById(R.id.mathmarks1);
        f1=(EditText) findViewById(R.id.humlabmarks1);
        g1=(EditText) findViewById(R.id.phylabmarks1);

        h1=(EditText) findViewById(R.id.clabmarks1);

        i1=(EditText) findViewById(R.id.c1108labmarks1);


    }
    public void onclicksx(View view)
    {
      //  final MediaPlayer s=MediaPlayer.create(this,R.raw.song);
      //  s.start();
...
////////////////////////
        ...
        Intent in= new Intent(this,allcgpaview.class);
        in.putExtra(cse11marks, pass);
